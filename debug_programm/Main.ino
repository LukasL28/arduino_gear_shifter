...
// --------------------------------------------------------------------------
// Change timings here!
int clutch_push_delay = 300;  //in ms
int clutch_release_delay = 300;  //in ms
int between_piston_delay = 75; //in ms
int between_valve_delay = 25; //in ms
...
Serial.print("Button_Reverse_unlock: ");
Serial.println(Button_Reverse_unlock);
Serial.print("Button_Nlock: ");
Serial.println(Button_Nlock);
Serial.println("----------");
